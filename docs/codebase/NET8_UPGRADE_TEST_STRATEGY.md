...
P0（升級閘門 / 會悄悄改資料）
  ...
  B  ★ double.TryParse 特殊浮點 token + AverageOfSumSquare 下游 characterization（capture；本輪 fixture 走 fail_n=0 分支:net462 NaN→OverflowException→空 list,net8 跳過→1 筆。fail_n≠0 的 SeperatePassValue spec 汙染鏈見下,留待 Tier 3 廣度擴張）
