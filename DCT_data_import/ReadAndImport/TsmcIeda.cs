    ...
    public class TsmcIeda : ImportData
    {
        ...
        public List<string> GetNetNameList(string aseLot, int recursive = 0)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    writeToLog.WriteToDataImportLog("TSMC 之 CSV 讀檔錯誤:" + ftpserver + "  error:" + ex.Message);
                    RenameFile(ftpserver, errorDir + filename, Program.FTP_USER, Program.FTP_PASSWORD);
        ...
        public string GetLotMapping()
        {
            ...
            {
                writeToLog.WriteToDataImportLog("'GetLotMapping() error:" + ex.Message);
                return ex.Message;
            }
        ...
        public bool ImportIeda(IedaDataFormat content, DatabaseService DatabaseService)
        {
            ...
            {
                writeToLog.WriteToDataImportLog("'INSERT INTO ieda_title' error:" + ex.Message);
                return false;
            }
            #endregion
            ...
            {
                writeToLog.WriteToDataImportLog("'INSERT INTO ieda_content' error:" + ex.Message);
                return false;
            }
            #endregion
            return true;
