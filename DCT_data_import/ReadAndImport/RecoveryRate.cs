...
namespace DCT_data_import.ReadAndImport
{
    ...
    {
        public ImportResult ReadAndImportRecoveryRateData(FileProcess fileAccess, DatabaseService DatabaseService, string dbKey)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (import_result)
                    {
                        ...
                        LogImportSuccess(writeToLog, "RecoveryRate", dbKey, filename, importTakeTime, deleteStatus);
        ...
        internal RecoveryRateDataContentFormat FileReadRecoveryRateData(StreamReader reader)
        {
            ...
            catch (Exception ex)
            {
                ...
                writeToLogService.WriteErrorLog($"[FileReadRecoveryRateData] 讀檔內容錯誤, 錯誤: {ex.Message}");
